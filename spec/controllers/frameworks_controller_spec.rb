...
RSpec.describe FrameworksController, :type => :controller do
  ...
  describe "GET new" do
    it "assigns a new framework as @framework" do
      ...
      expect(assigns(:framework)).to be_a_new(Framework)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created framework as @framework" do
        post :create, {:framework => valid_attributes}, valid_session
        expect(assigns(:framework)).to be_a(Framework)
        expect(assigns(:framework)).to be_persisted
      end

      it "redirects to the created framework" do
        post :create, {:framework => valid_attributes}, valid_session
        expect(response).to redirect_to(Framework.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved framework as @framework" do
        post :create, {:framework => invalid_attributes}, valid_session
        expect(assigns(:framework)).to be_a_new(Framework)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested framework" do
        framework = Framework.create! valid_attributes
        put :update, {:id => framework.to_param, :framework => new_attributes}, valid_session
        framework.reload
      ...
      it "redirects to the framework" do
        framework = Framework.create! valid_attributes
        put :update, {:id => framework.to_param, :framework => valid_attributes}, valid_session
        expect(response).to redirect_to(framework)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the framework as @framework" do
        framework = Framework.create! valid_attributes
        put :update, {:id => framework.to_param, :framework => invalid_attributes}, valid_session
        expect(assigns(:framework)).to eq(framework)
      end
